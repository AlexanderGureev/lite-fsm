...
| `EntityIndex`                                               | branded `number`; индекс строки в колонках (`self.x[entity]`, `view.x[entity]`). Для public view значение колонки имеет смысл только при `view.has(entity) === true`                                                                                                                                                                                          |
