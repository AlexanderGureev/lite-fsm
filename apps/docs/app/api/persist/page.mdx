...
`@lite-fsm/persist` сохраняет `MachineManager` snapshot в произвольное хранилище и восстанавливает его обратно.
...
| `throttleMs?` | Минимальный интервал между save |
| `shouldSave?` | Фильтр transitions перед save |
