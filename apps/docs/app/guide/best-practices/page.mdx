...
> **Примечание:** Подробное руководство по композиции автоматов и организации файловой структуры есть в разделе [Создание автомата](/guide/advanced-concepts/create-machine).
...
См. также раздел [Параллельные автоматы](/guide/advanced-concepts/parallel).
...
См. также раздел [Работа с TypeScript](/usage/typescript).
