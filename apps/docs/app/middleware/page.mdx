...
> Раздел переехал в [Пакеты / @lite-fsm/middleware](/packages/middleware). Эта страница оставлена для старых внешних ссылок.

Middleware расширяют `MachineManager`: подключают Immer, отправляют события в Redux DevTools и дают место для собственных обработчиков, например логирования, аналитики или сохранения состояния.
