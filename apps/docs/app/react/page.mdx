...
> Раздел переехал в [Пакеты / @lite-fsm/react](/packages/react). Эта страница оставлена для старых внешних ссылок.
...
React-интеграция публикуется отдельным npm-пакетом:
